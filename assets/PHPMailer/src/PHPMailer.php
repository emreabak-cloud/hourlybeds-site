...
class PHPMailer
{
    ...
    /**
     * Output debugging info via a person-defined method.
     ...
     *
     * @see https://www.andrew.cmu.edu/person/agreen1/testing/mrbs/web/Mail/RFC822.php A more careful implementation
     *
     ...
     *
     * ```php
     * PHPMailer::validateAddress('person@example.com', function($address) {
     ...
     *                          Do not set this from person input!
     *
     ...
     *                     [['joe@example.com', 'Joe person'], ['zoe@example.com', 'Zoe person']]
     *
     * @return string
     */
     ...
     * Never use a person-supplied path to a file!
     ...
     * Do not source $message content from person input!
     ...
     *                                *Never* pass person-supplied data into this parameter
     *
     * @return string
     */
